"""
Laptop AI Integration for Smart Classroom
Works with your ESP32 + Firebase setup
"""
...
class LaptopAIDetector:
    def __init__(self, firebase_url="https://smartclassroom-af237-default-rtdb.firebaseio.com", room_id="roomA"):
        ...
        # Use CPU for compatibility (still fast enough)
    ...
    def update_firebase(self, presence, people_count, max_confidence):
        ...
        try:
            ...
            if response.status_code == 200:
                print(f"📡 Firebase updated: AI presence={presence}, people={people_count}, conf={max_confidence:.2f}")
                return True
            else:
    ...
    def run_detection(self):
        ...
        if not cap.isOpened():
            ...
            print("💡 Make sure:")
            print("   - Camera is not used by other apps")
        ...
        print("🔗 AI detection will update your ESP32 lighting system!")
        ...
        try:
            while True:
                ...
                cv2.putText(display_frame, status, (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 255), 2)
                
                # Add Firebase status
                firebase_status = "Firebase: Connected" if current_time - self.last_firebase_update < 10 else "Firebase: Disconnected"
                cv2.putText(display_frame, firebase_status, (10, 60), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 1)
                
                # Show frame
                cv2.imshow('Smart Classroom AI Detection', display_frame)
...
if __name__ == "__main__":
    print("🚀 Smart Classroom AI Detection Starting...")
    print("🎯 This will work with your ESP32 + Firebase system!")
    
    # Create detector (uses your real Firebase)
    detector = LaptopAIDetector(
